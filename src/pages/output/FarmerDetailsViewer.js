                ...
                {farmerDetails.length ? (
                    farmerDetails.map((record, index) => (
                        <Paper key={index} style={{ padding: "20px", margin: "20px 0" }}>
                            ...
                            <Typography>
                                <strong>Record ID:</strong> {record.uniqueId}
                            </Typography>
                            <Typography>
                                <strong>Farmer ID:</strong> {record.farmerId}
                            </Typography>
                            <Typography>
                                <strong>Full Name:</strong> {record.fullName}
                            </Typography>
                            <Typography>
                                <strong>Address:</strong> {record.fAddress}
                            </Typography>
                            <Typography>
                                <strong>Year:</strong> {record.year}
                            </Typography>
                            <Typography>
                                <strong>Crop Season:</strong> {record.cropSeason}
                            </Typography>
                            <Typography>
                                <strong>Cultivated Area:</strong> {record.culArea}
                            </Typography>
                            <Typography>
                                <strong>Zone:</strong> {record.zone}
                            </Typography>
                            <Typography>
                                <strong>Seed:</strong> {record.seed}
                            </Typography>
                            <Typography>
                                <strong>Paddy Weight:</strong> {record.weightPaddy}
                            </Typography>
                            <Typography>
                                <strong>Farmer Sell Price:</strong> {record.farmerSellPrice}
                            </Typography>
                            <Typography>
                                <strong>Total Cost:</strong> {record.totalCost}
                            </Typography>
                            <Typography>
                                <strong>Cost Per KG:</strong> {record.costPerKg}
                            </Typography>
                            ...
                            {sellerRecords.length > 0 ? (
                                sellerRecords.map((sellerRecord, i) => {
                                    if (sellerRecord.uniqueId === record.uniqueId) {
                                        return (
                                            <div key={i}>
