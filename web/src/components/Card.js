...
const Card = () => {
    ...
    const navigateToLandprep = () => {
        navigate('/Landprep', { state: { cardData: { fullName, address, cropSeason, culArea, zone } } });
    ...
    const handleCulAreaChange = (e) => {
      ...
      const handlezoneonChange = (e) => {
        ...
        if (newValue !== "Wet" && newValue !== "Dry" && newValue !== "Intermidiate") {
    ...
    return (
        ...
        <form className='form' onSubmit={getQRCode}>
            ...
            />
            {cropSeasonError && <div className='error-message'>{cropSeasonError}</div>}
            ...
            />
            {culAreaError && <div className='error-message'>{culAreaError}</div>} {/* Display error message */}
            ...
            {zoneError && <div className='error-message'>{zoneError}</div>} {/* Display error message */}
            ...
            <div className='download-container'>
                ...
                <Button variant="contained" color="primary" onClick={navigateToLandprep}> Next
                </Button>
            </div>
